...
CREATE TABLE duplicata (
    Nome CHAR(40) COMMENT 'Nome do Cliente',
    Numero INTEGER NOT NULL PRIMARY KEY COMMENT 'Número do pagamento',
    Valor DECIMAL(10,2) COMMENT 'Valor do pagamento',
    Vencimento DATE COMMENT 'Data de vencimento do pagamento',
    Banco CHAR(10) COMMENT 'Nome do Banco'
);

ALTER TABLE duplicata
MODIFY COLUMN Banco CHAR(16);
...
INSERT INTO duplicata VALUES
    ...
    ('ABC PAPELARIA', '100130', '8000', '2016-10-15', 'SANTANDER'),
    ...
    ('LIVROS MM', '250360', '500', '2018-12-18', 'SANTANDER'),
    ('LIVROS MM', '250370', '3400', '2018-04-26', 'SANTANDER'),
    ('PAPELARIA SILVA', '250380', '3500', '2018-04-26', 'BANCO DO BRASIL'),
    ('LIVROS E CIA', '453360', '1500', '2018-06-15', 'ITAU'),
    ('LIVROS MM', '453365', '5400', '2018-06-15', 'BRADESCO'),
    ...
    ('LIVRARIA FERNANDES', '770710', '2500', '2016-11-15', 'SANTANDER'),
    ('ABC PAPELARIA', '985001', '3000', '2016-09-11', 'ITAU'),
    ('PAPEL E AFINS', '985002', '2500', '2016-03-12', 'SANTANDER'),
